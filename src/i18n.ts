...
const it = {
  ...
  pushDaily: 'Buongiorno e buonanotte',
  pushNote: 'Alle 9 e alle 22, con una frase del Grimorio e gli eventi del giorno.',
  pushInstall: 'Su iPhone servono con l’app aggiunta alla schermata Home: Condividi → Aggiungi a Home.',
  pushDenied: 'Permesso negato. Puoi riattivarlo dalle impostazioni del telefono.',
  pushUnsupported: 'Questo browser non le gestisce.',
...
const en: Dict = {
  ...
  pushDaily: 'Good morning and good night',
  pushNote: 'At 9 and at 22, with a line from the Grimoire and the day’s events.',
  pushInstall: 'On iPhone these need the app added to the Home Screen: Share → Add to Home Screen.',
  pushDenied: 'Permission denied. You can turn it back on in your phone settings.',
  pushUnsupported: 'This browser doesn’t support them.',
  yourName: 'Your name',
